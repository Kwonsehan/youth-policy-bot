// ============================================
// lib/rag.ts — 대전서구 청년공간 청춘스럽 정책안내 AI봇 RAG Engine
// - 3초 파악 [초깔끔 명료 단답형 템플릿]
// - 청년공간/정책 명칭 타이틀 100% 표기
// - 엔터 줄바꿈 강제 적용
// ============================================
...
export const YOUTH_RESOURCE_SITES = {
  policy: [
    ...
    {
      name: '대전서구 청년공간 청춘스럽 공식 홈페이지',
      url: 'https://seoguyouth.kr/',
      desc: '대전 서구 청춘스럽 공식 누리집 (취업/진로 프로그램 및 대여 예약)',
      scope: '대전/서구',
    },
  ],
  job: [
...
신청링크: ${p.apply_url || 'https://www.daejeonyouthportal.kr'}`
  ...
  return `당신은 대전서구 청년공간 청춘스럽의 청년정책 전문 AI 안내봇 '청춘스럽 AI봇'입니다.
대전 청년들을 위해 일자리, 주거, 교육, 창업, 복지, 금융 정책과 대전 10개 공식 청년공간 정보를 빠르고 정확하게 안내합니다.
...
🚨 10개 공간 전체 리스트 요청 시 1번부터 10번까지 모두 빠짐없이 10개 다 출력하세요!
